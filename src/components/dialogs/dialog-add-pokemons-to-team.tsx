...
export default function DialogAddPokemonToTeams ({ open, setOpen, pokemonIds }: Props) {
  ...
  // Estado para seleccionar un equipo
  ...
  //
  // Estado para abrir el dialogo de crear equipo en caso de que no exista
          ...
          <Dialog.Header className="flex items-center justify-between w-full p-6">
            <div className="flex items-center justify-start gap-4">
              ...
              <div className="grid gap-1">
                ...
                <p className="text-sm">Selecciona un pokemon para agregarlo al equipo.</p>
              </div>
            </div>
                ...
                <div className="w-full h-full flex items-center justify-between py-4 px-6">
                  ...
                  }
                  {
                    teams?.length > 0 ? (
                      <select
                        value={team?.id ?? ''}
                        className="border border-border rounded h-8 bg-background px-2 text-sm min-w-36"
                        onChange={e => {
                      ...
                      <div className='w-full flex justify-end'>
                        <div className='border border-border rounded h-8 bg-background px-6 text-sm inline-flex items-center justify-center'>
                      Sin equipos
                        </div>
                      </div>
                    )
                      ...
                      data?.map((p: Pokemon) => {
                        ...
                        return (
                          <div
                            key={p.id}
                            className={cn(
                              'group w-full rounded-xl border flex items-center justify-between p-3 cursor-pointer transition aria-disabled:pointer-events-none aria-disabled:opacity-50',
