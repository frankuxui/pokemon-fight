...
const Spinner = React.forwardRef<HTMLDivElement, SpinnerProps>(({
  ...
  return (
    <div
      ref={ref}
      className={cn(
        'inline-block flex-none border-[2px] rounded-full animate-spin animate-duration-1000',
        ...
        variant === 'dark' && 'border-foreground/20 border-t-foreground ',
        variant === 'light' && 'border-white/30 border-t-white',
